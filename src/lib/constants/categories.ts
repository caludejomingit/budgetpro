...
export const CAT_COLORS: string[] = [
  '#1E6B4E', '#C97452', '#3D6B5C', '#C9A03D', '#4C7A94', '#8B6BB0', '#3E8E7E', '#B0574F',
  '#6E8C4A', '#8E5B4A', '#A88B3F', '#4E6E8C', '#7A6E5E', '#5B7A6E', '#5C8A72', '#7A5D3F',
  '#B0894A', '#6B5B95', '#4F8FA6', '#A65D57', '#598C6E', '#8C7548', '#7E6BA6', '#4E7A8C',
];
